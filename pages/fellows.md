...
**Project Statement**
Strong vocabulary knowledge is critical for children’s academic success (Morgan et al., 2015). By the age of three, there is already a significant gap in word knowledge between children from socioeconomically disadvantaged families and their higher SES peers (Hart & Risley, 1995). Despite efforts to redress this gap, interventions have made little progress (Wasik et al., 2016). This may be because researchers currently do not have a strong understanding of how preschoolers learn words (Wasik et al., 2016). Researchers have recently suggested that the translation of knowledge from the science of word learning to literacy research may be one way to increase the effectiveness of vocabulary instruction (Hassinger-Das et al., 2017). The current project attempts to imbue the way children organically learn words into a Head Start classroom intervention. Two principles inform the creation of this intervention. The first is that children’s word knowledge becomes more sophisticated over time (Bergelson & Aslin, 2017). The second is that children develop rich word knowledge through semantic network building (Borovsky et al., 2016). The current intervention will attempt to mimic how children naturally learn words by gradually increasing depth of knowledge and fostering the growth of semantic networks. The study will compare this theoretical approach to the method in which vocabulary interventions are typically implemented in the classroom.
...
![Cody Spence]({{site.baseurl}}/media/resizedcodyspence.jpg){:.responsive-img .img-right}
**Cody Spence (Sociology)**<br>
**Fellowship - Research Team Fellow**<br>

Cody is a PhD candidate in the Department of Sociology at Temple University. His research interest include immigration and public policy.
